    ...
    <>
      ...
      <div className="flex" id="signup-container">
        <form className="form-flex-col" onSubmit={handleSubmit(onSubmit)}>
          ...
          />
          {errors['first-name'] && <div className='error-message'>{errors['first-name'].message}</div>}
          ...
          />
          {errors['last-name'] && <div className='error-message'>{errors['last-name'].message}</div>}
          ...
          />
          {errors['confirm-password'] && <div className='error-message'>{errors['confirm-password'].message}</div>}

          <button type="submit">Submit</button>
        </form>
      </div>
        {validationMessage && <div className='center error-message'>{validationMessage}</div>}
    </>
  );
}
